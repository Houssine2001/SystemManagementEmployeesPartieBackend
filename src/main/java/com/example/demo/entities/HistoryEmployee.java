...
public class HistoryEmployee {
    ...
    private LocalDateTime dateEmotion; // Date et heure de l'émotion
    ...
    public HistoryEmployee(String idEmploye, String nom, String emotion, LocalDateTime dateEmotion, double emotionScore) {
    ...
    public LocalDateTime getDateEmotion() {
        return dateEmotion;
    }

    public void setDateEmotion(LocalDateTime dateEmotion) {
        this.dateEmotion = dateEmotion;
    }
